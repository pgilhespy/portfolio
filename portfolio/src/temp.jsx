...
export default function Portfolio() {
  ...
  const startContinuousGradientAnimation = () => {
    ...
    continuousAnimationRef.current = gsap.to(backgroundRef.current, {
      "--gradient-angle": `${gradientAngleRef.current + 2}deg`,
      duration: 3,
      ease: "sine.inOut",
      yoyo: true,
      repeat: -1,
                      ...
                      <div className="hero-bottom-section">
                        <div className="hero-left-bottom">
                          <div className="description">
                            <p>
                              <b>I'm a 22 year</b> old creative who likes to make things that people can use, watch and
                              enjoy. I like to think I'm quite good at what I do and I'm both quite willing and able to
                              prove it to you. So please, have a look around and see what you think.
                            </p>
                          </div>
                        ...
                        <div className="reel-container">
                          <div className="reel-overlay">
                            <span className="reel-text">Show reel</span>
                          </div>
                          <video className="reel-video" autoPlay loop muted playsInline src={reel}></video>
                        </div>
                      </div>
                    </div>
                  </div>
